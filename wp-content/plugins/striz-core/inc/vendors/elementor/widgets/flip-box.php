...
class OSF_Elementor_Flip_Box extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Flip Box', 'striz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'striz-core' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'striz-core' ) ] );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'This is the sub title', 'striz-core' ),
...
//				'show_label' => false,
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'striz-core' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay', 'striz-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'striz-core' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'striz-core' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'striz-core' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'striz-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'striz-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
		...
		$this->add_control(
			'icon_rotate',
			[
				'label' => __( 'Icon Rotate', 'striz-core' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
