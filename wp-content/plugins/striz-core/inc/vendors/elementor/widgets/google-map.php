...
class OSF_Elementor_Google_Map extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Google Maps', 'striz-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'latitude',
            array(
                'label'   => __('Latitude', 'striz-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '21.030497',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'striz-core' ), 'https://www.google.com/maps')
            )
        ...
        $this->add_control(
            'longitude',
            array(
                'label'   => __('Longitude', 'striz-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '105.852510',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Ex: 21.030497, 105.852510. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'striz-core' ), 'https://www.google.com/maps')
            )
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => [ 'size' => 500 ],
                'description' => esc_html__( 'Height of map.(px)', 'striz-core' ),
                'selectors' => [
        ...
        $this->add_control(
            'zoom',
            [
                'label' => __( 'Zoom Level', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_control(
            'prevent_scroll',
            [
                'label' => __( 'Prevent Scroll', 'striz-core' ),
        ...
        $this->add_control(
            'water_color',
            [
                'label' => __( 'Water Color', 'striz-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
        ...
        $this->add_control(
            'water_lightness',
            [
                'label' => __( 'Water Lightness', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            'landscape_color',
            [
                'label' => __( 'Landscape Color', 'striz-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
        ...
        $this->add_control(
            'landscape_lightness',
            [
                'label' => __( 'Landscape Lightness', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Color', 'striz-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Lightness', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'poi_lightness',
            [
                'label' => __( 'Poi Lightness', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'road_color',
            [
                'label' => __( 'Road Color', 'striz-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
        ...
        $this->add_control(
            'road_lightness',
            [
                'label' => __( 'Road Lightness', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'transit_color',
            [
                'label' => __( 'Transit Color', 'striz-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
        ...
        $this->add_control(
            'transit_lightness',
            [
                'label' => __( 'Transit Lightness', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
    ...
    private function data_style_title(){
        return array(
            ...
            'ultra_light' => __('Ultra Light', 'striz-core'),
            'shades_of_grey' => __('Shades of Grey', 'striz-core'),
            'blue_water' => __('Blue Water', 'striz-core'),
            'light_grey_and_blue' => __('Light Grey and Blue', 'striz-core'),
            'farma_gray' => __('Farma Gray', 'striz-core'),
            'community' => __('Community', 'striz-core'),
            'chilled' => __('Chilled', 'striz-core'),
            'customize' => __('Customize', 'striz-core')
