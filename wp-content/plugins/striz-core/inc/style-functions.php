...
function osf_theme_custom_css() {
    $a1root = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/a1root.php';
    $grid = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/grid.php';
    $button = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/button.php';
    $error_404 = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/error-404.php';
    $heading = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/heading.php';
    $main_layout = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/main-layout.php';
    $page_bg = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/page-bg.php';
    $page_title = include trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'inc/customize/page-title.php';
    $css = <<<CSS
{$a1root}
{$grid}
{$error_404}
