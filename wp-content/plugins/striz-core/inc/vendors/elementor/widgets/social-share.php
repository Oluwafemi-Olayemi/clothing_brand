...
class OSF_Element_Social_Share extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Social Share', 'striz-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Share Buttons', 'striz-core' ),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label' => __( 'Select Socials', 'striz-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'gradient' => __( 'Gradient', 'striz-core' ),
                    'minimal' => __( 'Minimal', 'striz-core' ),
                    'framed' => __( 'Framed', 'striz-core' ),
                    'boxed' => __( 'Boxed Icon', 'striz-core' ),
                    'flat' => __( 'Flat', 'striz-core' ),
                ],
                'default' => 'gradient',
        ...
        $this->add_responsive_control(
            'column_gap',
            [
                'label'     => __( 'Columns Gap', 'striz-core' ),
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label' => __( 'Button Size', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label' => __( 'Button Height', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'em' => [
                        'min' => 1,
        ...
        $this->add_control(
            'text_padding',
            [
                'label' => __( 'Text Padding', 'striz-core' ),
            ...
            <?php foreach ( $settings['socials'] as $button ) {
                ...
                <div class="elementor-grid-item">
                    <div class="elementor-share-btn">
                        <a href="<?php $this->render_html_social($button); ?>" target="_blank" title="<?php printf( __('Share on %s', 'striz-core'), $title)?>">
