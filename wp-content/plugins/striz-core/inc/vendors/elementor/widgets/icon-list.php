...
class OSF_Widget_Icon_List extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Icon List', 'striz-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'traditional' => [
                        'title' => __( 'Default', 'striz-core' ),
                        'icon' => 'eicon-editor-list-ul',
                    ],
                    'inline' => [
                        'title' => __( 'Inline', 'striz-core' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __( 'List Item', 'striz-core' ),
                'default' => __( 'List Item', 'striz-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'text' => __( 'List Item #1', 'striz-core' ),
                        'icon' => 'fa fa-check',
                    ],
                    [
                        'text' => __( 'List Item #2', 'striz-core' ),
                        'icon' => 'fa fa-times',
                    ],
                    [
                        'text' => __( 'List Item #3', 'striz-core' ),
        ...
        $this->add_control(
            'text_indent',
            [
                'label' => __( 'Text Indent', 'striz-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
