<?php
add_action('after_switch_theme', 'xstriz_starter_settings');
function xstriz_starter_settings() {
    if (!get_theme_mod('osf_starter_settings_123', false)) {
        ...
        set_theme_mod('osf_starter_settings_123', true);
    }
}
