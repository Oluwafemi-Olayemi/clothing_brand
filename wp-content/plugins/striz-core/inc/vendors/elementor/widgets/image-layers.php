...
class OSF_Elementor_Image_Layers_Widget extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section('img_layers_content',
            [
                'label' => esc_html__('Images', 'striz-core'),
            ]
        );
        ...
        $repeater->add_control('layers_select',
            [
                'label' => esc_html__('Select Content', 'striz-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image Content', 'striz-core'),
                    'text' => esc_html__('Text Content', 'striz-core'),
                ],
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control('img_layers_image',
            [
                'label' => esc_html__('Upload Image', 'striz-core'),
        ...
        $repeater->add_control('img_layers_alt',
            [
                'label' => esc_html__('Alt', 'striz-core'),
        ...
        $repeater->add_control('text_layers',
            [
                'label' => esc_html__('Content', 'striz-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Lorem ipsum dolor sit amet', 'striz-core'),
                'condition' => [
                    'layers_select' => 'text'
                ]
            ]
        ...
        $repeater->add_control('text_color',
            [
                'label' => esc_html__('Color', 'striz-core'),
        ...
        $repeater->add_control('img_layers_position',
            [
                'label' => esc_html__('Position', 'striz-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'relative' => esc_html__('Relative', 'striz-core'),
                    'absolute' => esc_html__('Absolute', 'striz-core'),
                ],
                'default' => 'relative'
            ]
        );
        ...
        $repeater->add_responsive_control('img_layers_hor_position',
            [
                'label' => esc_html__('Horizontal Offset', 'striz-core'),
                'type' => Controls_Manager::SLIDER,
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'striz-core'),
                'size_units' => ['px', "em", '%'],
                'range' => [
                    'px' => [
                        'min' => -200,
        ...
        $repeater->add_responsive_control('img_layers_ver_position',
            [
                'label' => esc_html__('Vertical Offset', 'striz-core'),
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'striz-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', "em", '%'],
                'range' => [
        ...
        $repeater->add_control('img_layers_rotate',
            [
                'label' => esc_html__('Rotate', 'striz-core'),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $repeater->add_control('img_layers_rotatex',
            [
                'label' => esc_html__('Degrees', 'striz-core'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Set rotation value in degress', 'striz-core'),
                'min' => -180,
                'max' => 180,
                'condition' => [
        ...
        $repeater->add_control('img_layers_animation',
            [
                'label' => esc_html__('Entrance Animation', 'striz-core'),
        ...
        $repeater->add_control('img_layers_animation_duration',
            [
                'label' => __('Animation Duration', 'striz-core'),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    'slow' => __('Slow', 'striz-core'),
                    '' => __('Normal', 'striz-core'),
                    'fast' => __('Fast', 'striz-core'),
                ],
                'condition' => [
                    'img_layers_animation_switcher' => 'yes',
        ...
        $repeater->add_control('img_layers_animation_delay',
            [
                'label' => esc_html__('Animation Delay', 'striz-core') . ' (s)',
                'type' => Controls_Manager::NUMBER,
                'default' => '',
                'min' => 0,
                'step' => 0.1,
        ...
        $repeater->add_control('img_layers_mouse',
            [
                'label' => esc_html__('Mousemove Interactivity', 'striz-core'),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__('Enable or disable mousemove interaction', 'striz-core'),
            ]
        );

        $repeater->add_control('img_layers_mouse_type',
            [
                'label' => esc_html__('Interactivity Style', 'striz-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'parallax' => esc_html__('Mouse Parallax', 'striz-core'),
                    'tilt' => esc_html__('Tilt', 'striz-core'),
                ],
                'default' => 'parallax',
                'label_block' => true,
                'condition' => [
        ...
        $repeater->add_control('img_layers_rate',
            [
                'label' => esc_html__('Rate', 'striz-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => -10,
                'min' => -20,
                'max' => 20,
                'step' => 1,
                'description' => esc_html__('Choose the movement rate for the layer image, default: -10', 'striz-core'),
                'separator' => 'after',
                'label_block' => true,
                'condition' => [
                    'img_layers_mouse' => 'yes',
        ...
        $repeater->add_control('img_layers_zindex',
            [
                'label' => esc_html__('z-index', 'striz-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => 1,
                'selectors' => [
        ...
        $repeater->add_control('img_layers_class',
            [
                'label' => esc_html__('CSS Classes', 'striz-core'),
                'type' => Controls_Manager::TEXT,
                'description' => esc_html__('Separate class with spaces', 'striz-core'),
            ]
        );
