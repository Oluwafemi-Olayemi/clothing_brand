...
class OSF_Elementor_Section {
    ...
    public function register_controls($element, $args) {
        ...
        $element->add_control(
            'sticky_show',
            [
                'label'        => __('Enable Sticky', 'striz-core'),
    ...
    public function register_controls_advanced($element, $args) {
        ...
        $element->add_responsive_control(
            'sticky_padding',
            [
                'label'              => __('Padding Sticky', 'striz-core'),
                ...
                'description' => __( 'padding when sticky active', 'striz-core' ),
            ]
        );
    }
    ...
    public function register_controls_background($element, $args) {
        ...
        $element->add_control(
            ...
            [
                'label'     => __('Background Sticky Active', 'striz-core'),
