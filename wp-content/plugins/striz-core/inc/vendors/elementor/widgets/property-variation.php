...
class OSF_Widget_Property_Variation extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Property Variation', 'striz-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Property Variation', 'striz-core' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __( 'Title', 'striz-core' ),
        ...
        $repeater->add_control(
            'title2',
            [
                'label' => __( 'Title 2', 'striz-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __( 'Title 2', 'striz-core' ),
                'default' => __( 'Title 2', 'striz-core' ),
            ]
        );
        ...
        $repeater->add_control(
            'title3',
            [
                'label' => __( 'Title 3', 'striz-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __( 'Title 3', 'striz-core' ),
                'default' => __( 'Title 3', 'striz-core' ),
            ]
        );
        ...
        $repeater->add_control(
            'title4',
            [
                'label' => __( 'Title 4', 'striz-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __( 'Title 4', 'striz-core' ),
                'default' => __( 'Title 4 ', 'striz-core' ),
            ]
        );
        ...
        $repeater->add_control(
            'title5',
            [
                'label' => __( 'Title 5', 'striz-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __( 'Title 5', 'striz-core' ),
                'default' => __( 'Title 5 ', 'striz-core' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __( 'Title 6', 'striz-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'title' => __( 'TOWER PH1512', 'striz-core' ),
                        'title2' => __( '-', 'striz-core' ),
                        'title3' => __( '-', 'striz-core' ),
                        'title4' => __( '-', 'striz-core' ),
                        'title5' => __( '-', 'striz-core' ),
                        'title6' => __( '-', 'striz-core' ),
                    ],
                ],
                'title_field' => '{{{ title }}}',
            ]
        ...
        <div <?php echo $this->get_render_attribute_string( 'property_variation' ); ?>>
            ...
            <table class="table">
                ...
                <tr <?php echo $this->get_render_attribute_string( 'property_variation_item' ); ?>>
                    <th> <?php echo esc_html__('RESIDENCE', 'striz-core')?></th>
                    <th> <?php echo esc_html__('BED/BATH', 'striz-core')?></th>
                    <th> <?php echo esc_html__('SQ. FT.', 'striz-core')?></th>
                    <th> <?php echo esc_html__('SALE PRICE', 'striz-core')?></th>
                    <th> <?php echo esc_html__('RENT PRICE', 'striz-core')?></th>
                    <th> <?php echo esc_html__('FLOOR PLAN', 'striz-core')?></th>
                </tr>
                </thead>
                <tbody>
            <?php foreach ( $settings['property_variation'] as $index => $item ) : ?>
                        <tr <?php echo $this->get_render_attribute_string( 'property_variation_item' ); ?>>
                            ...
                            <td>
                                <a data-elementor-open-lightbox="no" href="<?php echo $item['title6']['url']; ?>" <?php echo $this->get_render_attribute_string( 'button' ); ?>>View now</a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                </tbody>
