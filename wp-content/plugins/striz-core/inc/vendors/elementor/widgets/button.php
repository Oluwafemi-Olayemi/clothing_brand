    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Click here', 'striz-core'),
            ]
        );
        ...
        $this->add_control(
            'button_css_id',
            [
                'label'       => __('Button ID', 'striz-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'title'       => __('Add your custom id WITHOUT the Pound key. e.g: my-id', 'striz-core'),
                'label_block' => false,
                'description' => __('Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'striz-core'),
                'separator'   => 'before',
        ...
        $this->start_controls_section(
            'contactform7',
            [
                'label' => __('Contact Form Popup', 'striz-core'),
            ]
        );
