 ...
 */
$default = '<h6 class="pull-left">' . esc_html__('Share this:', 'striz-core') . '</h6>';
...
<div class="pbr-social-share">
    ...
    <?php if (get_theme_mod('osf_facebook', true)): ?>
        <a class="bo-social-facebook"
           ...
           target="_blank" title="<?php esc_html_e('Share on facebook', 'striz-core'); ?>">
            <?php echo empty($socials_label) ? '<i class="fa fa-facebook"></i>' : esc_html__('Facebook', 'striz-core'); ?>
        </a>
    <?php endif; ?>
    ...
    <?php if (get_theme_mod('osf_twitter', true)): ?>
        <a class="bo-social-twitter"
           ...
           title="<?php esc_html_e('Share on Twitter', 'striz-core'); ?>">
            <?php echo empty($socials_label) ? '<i class="fa fa-twitter"></i>' : esc_html__('Twitter', 'striz-core'); ?>
        </a>
    <?php endif; ?>
    ...
    <?php if (get_theme_mod('osf_linkedin', true)): ?>
        <a class="bo-social-linkedin"
           ...
           target="_blank" title="<?php esc_html_e('Share on LinkedIn', 'striz-core'); ?>">
            <?php echo empty($socials_label) ? '<i class="fa fa-linkedin"></i>' : esc_html__('LinkedIn', 'striz-core'); ?>
        </a>
    <?php endif; ?>
    ...
    <?php if (get_theme_mod('osf_tumblr', true)): ?>
        <a class="bo-social-tumblr"
           ...
           target="_blank" title="<?php esc_html_e('Share on Tumblr', 'striz-core'); ?>">
            <?php echo empty($socials_label) ? '<i class="fa fa-tumblr"></i>' : esc_html__('Tumblr', 'striz-core'); ?>
        </a>
    <?php endif; ?>
...
'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" target="_blank"
           title="<?php esc_html_e('Share on Google plus', 'striz-core'); ?>">
            <?php echo empty($socials_label) ? '<i class="fa fa-google-plus"></i>' : esc_html__('Google+', 'striz-core'); ?>
        </a>
    <?php endif; ?>
    ...
    <?php if (get_theme_mod('osf_pinterest', true)): ?>
        <a class="bo-social-pinterest"
           ...
           target="_blank" title="<?php esc_html_e('Share on Pinterest', 'striz-core'); ?>">
            <?php echo empty($socials_label) ? '<i class="fa fa-pinterest"></i>' : esc_html__('Pinterest', 'striz-core'); ?>
        </a>
    <?php endif; ?>

    <?php if (get_theme_mod('osf_email', true)): ?>
        <a class="bo-social-envelope" href="mailto:?subject=<?php the_title(); ?>&amp;body=<?php the_permalink(); ?>"
           title="<?php esc_html_e('Email to a Friend', 'striz-core'); ?>">
            <?php echo empty($socials_label) ? '<i class="fa fa-envelope"></i>' : esc_html__('EMail', 'striz-core'); ?>
        </a>
    <?php endif; ?>
</div>
