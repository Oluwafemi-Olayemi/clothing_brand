...
class OSF_Widget_Layered_Nav extends WC_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = __( 'Display a list of attributes to filter products in your store.(OSF custom)', 'striz-core' );
        $this->widget_id          = 'otf_woocommerce_layered_nav';
        $this->widget_name        = __( 'OSF Filter Products by Attribute', 'striz-core' );
        parent::__construct();
    }
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title' => array(
                'type'  => 'text',
                'std'   => __( 'Filter by', 'striz-core' ),
                'label' => __( 'Title', 'striz-core' ),
            ),
            'attribute' => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => __( 'Attribute', 'striz-core' ),
                'options' => $attribute_array,
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'label'   => __( 'Display type', 'striz-core' ),
                'options' => array(
            ...
            'style' => array(
                ...
                'options' => array(
                    'one_column'          => __( '1 Column', 'striz-core' ),
                    'two_columns'   => __( '2 Columns', 'striz-core' ),
            ...
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __( 'Query type', 'striz-core' ),
                'options' => array(
