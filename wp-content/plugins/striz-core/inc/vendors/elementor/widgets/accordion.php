...
class OSF_Elementor_Accordion extends Widget_Accordion {
    ...
    public function get_title() {
        return __( 'Opal Accordion', 'striz-core' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Accordion Title', 'striz-core' ),
                'dynamic' => [
                    'active' => true,
                ],
                'label_block' => true,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Accordion Content', 'striz-core' ),
                'show_label' => false,
            ]
        );
        ...
        $this->add_control(
            'tabs',
            [
                'label' => __( 'Accordion Items', 'striz-core' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => __( 'Accordion #1', 'striz-core' ),
                        'tab_content' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'striz-core' ),
                    ],
                    [
                        'tab_title' => __( 'Accordion #2', 'striz-core' ),
                        'tab_content' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'striz-core' ),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Active Background', 'striz-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
