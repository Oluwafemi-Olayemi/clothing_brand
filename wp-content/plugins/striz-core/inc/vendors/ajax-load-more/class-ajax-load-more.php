...
class OSF_Ajax_Load_More {
    ...
    public function add_control_ajax_load_more($widget, $condition = array()) {
        $widget->start_controls_section(
            ...
            [
                'label'     => __('Ajax Load More', 'striz-core'),
        ...
        $widget->add_control(
            'ajax_show',
            [
                'label' => __('Enable load more', 'striz-core'),
        ...
        $widget->add_control(
            'button_label',
            [
                'label'     => __('Button Label', 'striz-core'),
        ...
        $widget->add_control(
            ...
            [
                'label'     => __('Button Loading Label', 'striz-core'),
                'type'      => Controls_Manager::TEXT,
                'condition' => [
                    'ajax_show' => 'yes'
                ]
        ...
        $widget->add_control(
            'ajax_scroll',
            [
                'label'        => __('Enable Scrolling', 'striz-core'),
                'type'         => Controls_Manager::SWITCHER,
                'description'  => __('Load more posts as the user scrolls the page.', 'striz-core'),
                'default'      => 'false',
                'return_value' => 'true',
                'condition'    => [
                    'ajax_show' => 'yes'
        ...
        $widget->start_controls_section(
            'section_ajax_style',
            [
                'label'     => __('Load More Button', 'striz-core'),
        ...
        $widget->add_group_control(
            ...
            [
                ...
                'label'    =>  __('Button Typo', 'striz-core'),
            ]
        );
