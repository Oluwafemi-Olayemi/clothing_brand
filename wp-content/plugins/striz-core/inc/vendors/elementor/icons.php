...
function osf_elementor_opal_icon_control_custom( $manager ) {
	$new_icons = json_decode( file_get_contents( trailingslashit( XSTREET_CORE_PLUGIN_DIR ) . 'inc/vendors/elementor/icons.json' ), true );
...
function osf_elementor_opal_icon_control_custom_26( $tabs ) {
	$tabs['opal-custom'] = [
		'name'          => 'opal-custom',
		'label'         => __( 'Opal Custom Font', 'striz-core' ),
		'prefix'        => 'opal-icon-',
		'displayPrefix' => 'opal-icon-',
		'labelIcon'     => 'fab fa-font-awesome-alt',
		'ver'           => '5.9.0',
		'fetchJson'     => XSTREET_CORE_PLUGIN_URL . 'inc/vendors/elementor/icons26.json',
		'native'        => true,
	];
