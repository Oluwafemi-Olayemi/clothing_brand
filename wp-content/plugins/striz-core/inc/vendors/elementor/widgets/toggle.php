...
class OSF_Widget_Toggle extends Widget_Toggle {
    ...
    protected function register_controls() {
        ...
        $repearer = new Repeater();

        $repearer->add_control('tab_title', [
            'label'       => __('Title & Content', 'striz-core'),
            'type'        => Controls_Manager::TEXT,
            'default'     => __('Toggle Title', 'striz-core'),
            'label_block' => true,
        ]);

        $repearer->add_control('tab_content', [
            'label'      => __('Content', 'striz-core'),
            'type'       => Controls_Manager::WYSIWYG,
            'default'    => __('Toggle Content', 'striz-core'),
            'show_label' => false,
        ]);
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Toggle Items', 'striz-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repearer->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => __('Toggle #1', 'striz-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'striz-core'),
                    ],
                    [
                        'tab_title'   => __('Toggle #2', 'striz-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'striz-core'),
                    ],
                ],
        ...
        $this->add_control(
            'icon_active',
            [
                'label'       => __('Active Icon', 'striz-core'),
                'type'        => Controls_Manager::ICON,
        ...
        $this->add_control(
            'show_item_first',
            [
                'label' => __('Show Item First', 'striz-core'),
        ...
        $this->add_control(
            'event_type',
            [
                'label'        => __('Event Type', 'striz-core'),
                'type'         => Controls_Manager::SELECT,
                'options'      => array(
                    'toggle'    => 'Toggle',
                    'accordion' => 'Accordion'
        ...
        $this->add_control(
            'tab_active_color',
            [
                'label'     => __('Active Color', 'striz-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options'     => [
                    'left'  => [
                        'title' => __('Start', 'striz-core'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'right' => [
                        'title' => __('End', 'striz-core'),
