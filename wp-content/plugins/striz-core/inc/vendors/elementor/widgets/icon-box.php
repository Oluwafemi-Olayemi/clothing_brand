...
class OSF_Widget_Icon_Box extends Widget_Icon_Box
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'title_text',
            [
                'label' => __('Title & Description', 'striz-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Enter your sub-title', 'striz-core'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => __('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'striz-core'),
        ...
        $this->add_control(
            'link_text',
            [
                'label' => __('Link Text', 'striz-core'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Enter your Link Text', 'striz-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'link_download',
            [
                'label' => __('Donload Link ?', 'striz-core'),
        ...
        $this->start_controls_section(
            'section_hover',
            [
                'label' => __('Icon Hover', 'striz-core'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'icon!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}}.elementor-view-framed:hover .elementor-icon, {{WRAPPER}}.elementor-view-default:hover .elementor-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.elementor-view-framed:hover .elementor-icon' => 'background-color: {{VALUE}}; border-color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Vertical Alignment', 'striz-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'top' => __('Top', 'striz-core'),
                    'middle' => __('Middle', 'striz-core'),
                    'bottom' => __('Bottom', 'striz-core'),
                ],
                'default' => 'top',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-icon-box .elementor-icon-box-title:hover' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-icon-box-subtitle-text' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-icon-box-content .elementor-icon-box-subtitle-text' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementor-icon-box-content .elementor-icon-box-subtitle-text',
                'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            ]
        );
        //-----------
...
//            [
//                'label' => __('Hover Color', 'x-street-core'),
//                'type' => Controls_Manager::COLOR,
//                'default' => '',
//                'selectors' => [
...
//        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-icon-box-link-text' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-icon-box-content .elementor-icon-box-link-text a' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-icon-box .elementor-icon-box-link-text a:hover' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementor-icon-box-content .elementor-icon-box-link-text a',
                'scheme' => Scheme_Typography::TYPOGRAPHY_3,
            ]
        );
        //-----------
    ...
    protected function render()
    {
        ...
        $has_link = !empty($settings['link_text']);
        ...
        $this->add_render_attribute('subtitle_text', 'class', 'elementor-icon-box-subtitle-text');
        $this->add_render_attribute('link_text', 'class', 'elementor-icon-box-link-text');
        ...
        <div class="elementor-icon-box-wrapper">
            ...
            <div class="elementor-icon-box-content">
                ...
                <?php if( !empty($settings['link_text']) && !empty($settings['link']['url']) ): ?>
                <div <?php echo $this->get_render_attribute_string('link_text'); ?>>
                    <<?php echo implode(' ', [$icon_tag, $link_attributes]); ?> <?php echo $this->get_render_attribute_string('link_text'); ?>>
