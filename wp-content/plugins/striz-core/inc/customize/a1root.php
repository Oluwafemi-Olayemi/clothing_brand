 ...
 */
$vc_grid_font = '';
$body_font    = osf_esc_font_weight(get_theme_mod('osf_typography_general_body_font'));
...
$tertiary_font = osf_esc_font_weight(get_theme_mod('osf_typography_general_tertiary_font'));
...
$quaternary_font = osf_esc_font_weight(get_theme_mod('osf_typography_general_quaternary_font'));
