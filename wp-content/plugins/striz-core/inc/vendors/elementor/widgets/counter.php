...
class OSF_Elementor_Counter extends Widget_Counter {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'starting_number',
            [
                'label'   => __('Starting Number', 'striz-core'),
        ...
        $this->add_control(
            'ending_number',
            [
                'label'   => __('Ending Number', 'striz-core'),
                'type'    => Controls_Manager::NUMBER,
                'default' => 100,
            ]
        );
        ...
        $this->add_control(
            'prefix',
            [
                'label'       => __('Number Prefix', 'striz-core'),
        ...
        $this->add_control(
            'suffix',
            [
                'label'       => __('Number Suffix', 'striz-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => __('Plus', 'striz-core'),
            ]
        );
        ...
        $this->add_control(
            'icon_select',
            [
                'label'     => __('Icon select', 'striz-core'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'use_icon',
                'options'   => [
                    'use_icon'  => __('Use Icon', 'striz-core'),
                    'use_image' => __('Use Image', 'striz-core'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label'     => __('Thousand Separator', 'striz-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'label_on'  => __('Show', 'striz-core'),
                'label_off' => __('Hide', 'striz-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __('Cool Number', 'striz-core'),
                'placeholder' => __('Cool Number', 'striz-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Sub Title', 'striz-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __('Description...', 'striz-core'),
            ]
        );
        ...
        $this->add_control(
            'wrapper_animation',
            [
                'label'     => __('Show animation line bottom', 'striz-core'),
                'type'      => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control(
            'height_line',
            [
                'label'      => __( 'Height Line', 'striz-core' ),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'line_color',
            [
                'label' => __( 'Line Color', 'striz-core' ),
        ...
        $this->add_control(
            'line_color_hover',
            [
                'label' => __( 'Line Color Hover', 'striz-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
