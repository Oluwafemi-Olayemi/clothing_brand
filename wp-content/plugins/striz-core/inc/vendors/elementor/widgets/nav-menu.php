...
class OSF_Elementor_Nav_Menu extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Nav Menu', 'striz-core');
    }
    ...
    protected function register_controls() {
        ...
        if (!empty($menus)) {
            $this->add_control(
                'menu',
                [
                    'label'        => __('Menu', 'striz-core'),
                    'type'         => Controls_Manager::SELECT,
                    'options'      => $menus,
                    'default'      => array_keys($menus)[0],
                    'save_default' => true,
                    'separator'    => 'after',
                    'description'  => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'striz-core'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'striz-core'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator'       => 'after',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'            => 'horizontal',
                'options'            => [
                    'horizontal' => __('Horizontal', 'striz-core'),
                    'vertical'   => __('Vertical', 'striz-core'),
                ],
        ...
        $this->add_control(
            'pointer',
            [
                'label'   => __('Pointer', 'striz-core'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'underline',
                'options' => [
                    'none'        => __('None', 'striz-core'),
                    'underline'   => __('Underline', 'striz-core'),
                    'overline'    => __('Overline', 'striz-core'),
                    'double-line' => __('Double Line', 'striz-core'),
                    'framed'      => __('Framed', 'striz-core'),
                    'background'  => __('Background', 'striz-core'),
                    'text'        => __('Text', 'striz-core'),
                    'dot'         => __('Dot', 'striz-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'indicator',
            [
                'label'        => __('Submenu Indicator', 'striz-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'classic',
                'options'      => [
                    'none'    => __('None', 'striz-core'),
                    'classic' => __('Classic', 'striz-core'),
                    'chevron' => __('Chevron', 'striz-core'),
                    'angle'   => __('Angle', 'striz-core'),
                    'plus'    => __('Plus', 'striz-core'),
                ],
        ...
        $this->add_responsive_control(
            'subMenusMinWidth',
            [
                'label'   => __('Min width Submenu(px)', 'striz-core'),
        ...
        $this->add_responsive_control(
            'subMenusMaxWidth',
            [
                'label'   => __('Max width Submenu(px)', 'striz-core'),
                'type'    => Controls_Manager::SLIDER,
                'range'   => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Mobile Dropdown', 'striz-core'),
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Enable Mobile Menu', 'striz-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'dropdown',
                'options'   => [
                    'dropdown' => __('Dropdown', 'striz-core'),
                    'canvas'   => __('Canvas', 'striz-core'),
                    'popup'    => __('Popup', 'striz-core'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'dropdown',
            [
                'label'        => __('Breakpoint', 'striz-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'tablet',
                'options'      => [
                    'mobile' => __('Mobile (767px >)', 'striz-core'),
                    'tablet' => __('Tablet (1023px >)', 'striz-core'),
                    'destop' => __('Destop', 'striz-core'),
                ],
        ...
        $this->add_control(
            'full_width',
            [
                'label'              => __('Full Width', 'striz-core'),
                'type'               => Controls_Manager::SWITCHER,
                'description'        => __('Stretch the dropdown of the menu to full width.', 'striz-core'),
        ...
        $this->add_responsive_control(
            'width_dropdown',
            [
                'label'      => __('Width Dropdown', 'striz-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'aside',
                'options'      => [
                    'aside'  => __('Aside', 'striz-core'),
                    'center' => __('Center', 'striz-core'),
                ],
        ...
        $this->add_control(
            'toggle',
            [
                'label'              => __('Toggle Button', 'striz-core'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'burger',
                'options'            => [
                    ''       => __('None', 'striz-core'),
                    'burger' => __('Hamburger', 'striz-core'),
                ],
        ...
        $this->add_responsive_control(
            'toggle_align',
            [
                'label'        => __('Toggle Align', 'striz-core'),
                'type'         => Controls_Manager::CHOOSE,
                'default'      => 'left',
                'options'      => [
                    'left'   => [
        ...
        $this->add_control(
            'menu-toggle-title',
            [
                'label'   => __('Title Toggle', 'striz-core'),
                'default' => 'Menu',
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Pointer Color', 'striz-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control(
            'pointer_width',
            [
                'label'     => __('Pointer Width', 'striz-core'),
                'type'      => Controls_Manager::SLIDER,
        ...
        $this->add_control(
            'pointer_height',
            [
                'label'     => __('Pointer Height', 'striz-core'),
                'type'      => Controls_Manager::SLIDER,
                'devices'   => [self::RESPONSIVE_DESKTOP, self::RESPONSIVE_TABLET],
                'range'     => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Horizontal Padding', 'striz-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Vertical Padding', 'striz-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            ...
            [
                'raw'             => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'striz-core'),
                'type'            => Controls_Manager::RAW_HTML,
        ...
        $this->add_control(
            'setting_icon_tongle',
            [
                'label'     => __('Icon Tongle', 'striz-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Title Tongle', 'striz-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
