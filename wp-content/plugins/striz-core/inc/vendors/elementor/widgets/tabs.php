...
class OSF_Elementor_Tabs extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Tabs', 'striz-core');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control('tab_title',[
            'label'       => __('Title & Content', 'striz-core'),
            'type'        => Controls_Manager::TEXT,
            'default'     => __('Tab Title', 'striz-core'),
            'placeholder' => __('Tab Title', 'striz-core'),
            'label_block' => true,
        ]);

        $repeater->add_control('source',[
            'label'   => __('Source', 'striz-core'),
            'type'    => Controls_Manager::SELECT,
            'default' => 'html',
            'options' => [
                'html'     => __('HTML', 'striz-core'),
                'template' => __('Template', 'striz-core'),
            ],
        ]);

        $repeater->add_control('tab_html',[
            'label'       => __('Content', 'striz-core'),
            'default'     => __('Tab Content', 'striz-core'),
            'placeholder' => __('Tab Content', 'striz-core'),
        ...
        $repeater->add_control('tab_template',[
            'label'       => __('Choose Template', 'striz-core'),
            'default'     => 0,
            'type'        => Controls_Manager::SELECT,
            'options'     => $options,
            'types'       => $types,
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Tabs Items', 'striz-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title' => __('Tab #1', 'striz-core'),
                        'source'    => 'html',
                        'tab_html'  => __('I am tab content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'striz-core'),
                    ],
                    [
                        'tab_title' => __('Tab #2', 'striz-core'),
                        'source'    => 'html',
                        'tab_html'  => __('I am tab content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'striz-core'),
                    ],
                ],
        ...
        $this->add_responsive_control(
            'navigation_width',
            [
                'label'      => __('Navigation Width', 'striz-core'),
