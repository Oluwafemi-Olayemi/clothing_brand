...
class OSF_Theme_Setup {
    ...
    public function widgets_init() {
        register_sidebar(array(
            'name'          => esc_html__('Single Posts Sidebar', 'striz-core'),
            'id'            => 'sidebar-single-post',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on single posts.', 'striz-core'),
        ...
        register_sidebar(array(
            'name'          => esc_html__('Blog Sidebar', 'striz-core'),
            'id'            => 'sidebar-blog',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on blog posts and archive pages.', 'striz-core'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
        ...
        register_sidebar(array(
            'name'          => esc_html__('Page Sidebar', 'striz-core'),
            'id'            => 'sidebar-page',
            'description'   => esc_html__('Add widgets here to appear in your pages.', 'striz-core'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
    ...
    public function modal_login_register() {
        include_once trailingslashit(XSTREET_CORE_PLUGIN_DIR) . 'templates/modal/login-register-form.php';
    }
    ...
    private function set_main_nav_content($items) {
        ...
        $items .= '<a data-search-toggle="toggle" data-target=".' . $id . '" class="fa fa-search" title="' . __("search", "striz-core") . '"></a>';
