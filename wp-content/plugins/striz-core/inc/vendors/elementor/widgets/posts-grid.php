...
class OSF_Elementor_Post_Grid extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Posts Grid', 'striz-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => __('Date', 'striz-core'),
                    'post_title' => __('Title', 'striz-core'),
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => __('Pagination', 'striz-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ''                      => __('None', 'striz-core'),
                    'numbers'               => __('Numbers', 'striz-core'),
                    'prev_next'             => __('Previous/Next', 'striz-core'),
                    'numbers_and_prev_next' => __('Numbers', 'striz-core') . ' + ' . __('Previous/Next', 'striz-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Page Limit', 'striz-core'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Previous Label', 'striz-core'),
                'default'   => __('&laquo; Previous', 'striz-core'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Next Label', 'striz-core'),
                'default'   => __('Next &raquo;', 'striz-core'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . __('Page', 'striz-core') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e('Pagination', 'striz-core'); ?>">
