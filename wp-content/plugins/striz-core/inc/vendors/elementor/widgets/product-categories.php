...
class OSF_Elementor_Products_Categories extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Product Categories', 'striz-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'categories_name',
            [
                'label' => __('Alternate Name', 'striz-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'image',
                'options' => [
                    'image' => __('Background image', 'striz-core'),
                    'embed' => __('Transparent', 'striz-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '1by1',
                'options'   => [
                    '21by9' => __('Ratio 21:9', 'striz-core'),
                    '16by9' => __('Ratio 16:9', 'striz-core'),
                    '4by3'  => __('Ratio 4:3', 'striz-core'),
                    '1by1'  => __('Ratio 1:1', 'striz-core'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'text_align_h',
            [
                'label'       => __('Horizontal Alignment', 'striz-core'),
        ...
        $this->add_control(
            'show_items',
            [
                'label'     => __('Show Items', 'striz-core'),
        ...
        $this->add_control(
            'show_button',
            [
                'label'     => __('Show Button', 'striz-core'),
                'type'      => Controls_Manager::SWITCHER,
                'separator' => 'before'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => __('View Collection', 'striz-core'),
                'condition' => [
                    'show_button' => 'yes',
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Show When Hover', 'striz-core'),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'active',
        ...
        $this->start_controls_section(
            'section_label_style',
            [
                'label' => __('Categories Style', 'striz-core'),
        ...
        $this->add_control(
            'item_color',
            [
                'label'     => __('Item Color', 'striz-core'),
        ...
        $this->add_control(
            'category_name_color',
            [
                'label'     => __('Name Color', 'striz-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    ...
                    <div class="cats-title">
                        <a href="<?php echo esc_url(get_term_link($category)); ?>"
                           title="<?php echo esc_attr($category->name); ?>">
                            <?php echo empty($settings['categories_name']) ? esc_html($category->name) : sprintf('%s', $settings['categories_name']); ?>
                        </a>
                    </div>
                    <?php
                    if ($settings['show_items'] === 'yes') {
                        ?>
                    <div class="cats-total">
                        <?php echo esc_html($category->count) . esc_html__(' items', 'striz-core'); ?>
                    </div>
                        <?php
                    }
                    ?>
