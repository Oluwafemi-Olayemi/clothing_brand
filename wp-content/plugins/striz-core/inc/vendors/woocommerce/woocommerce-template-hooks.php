...
// Wishlist
add_action('woocommerce_single_product_summary', 'osf_woocommerce_product_loop_wishlist_button', 45);

// Compare
add_action('woocommerce_single_product_summary', 'osf_woocommerce_product_loop_compare_button', 45);
...
function osf_include_hooks_product_blocks() {
    ...
    switch ($product_style) {
        case 2:
            ...
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_label_start', 0);
            add_action('woocommerce_shop_loop_item_title', 'woocommerce_show_product_loop_sale_flash', 1);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_label_end', 9);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_action_start', 15);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_action_end', 50);
            add_action('woocommerce_shop_loop_item_title', 'woocommerce_template_loop_product_title', 50);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_get_product_category', 60);
            ...
            // Wishlist
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_wishlist_button', 25);

            // Compare
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_compare_button', 30);
        ...
        default:
            ...
            add_action('woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_product_link_close', 99);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_caption_start', 0);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_group_transititon_start', 0);
            //add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_render_variable_size', 0);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_label_start', 0);
            add_action('woocommerce_shop_loop_item_title', 'woocommerce_show_product_loop_sale_flash', 1);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_get_product_label_stock', 5);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_label_end', 9);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_action_start', 15);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_action_end', 50);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_group_transititon_end', 50);
            add_action('woocommerce_shop_loop_item_title', 'woocommerce_template_loop_product_title', 50);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_get_product_category', 60);
            add_action('woocommerce_after_shop_loop_item_title', 'osf_woocommerce_product_loop_caption_end', 99);
