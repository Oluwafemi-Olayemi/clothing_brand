...
class OSF_Widget_Image_Box extends Widget_Image_Box
{
    ...
    {
        return __('Image Box', 'striz-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Hover Wrapper Animation', 'striz-core'),
        ...
        $this->add_control(
            'position',
            [
                'label' => __('Image Position', 'striz-core'),
        ...
        $this->add_control(
            'show_background_svg',
            [
                'label' => __('Show Background Decor', 'striz-core'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'view_bg',
            [
                'label' => __('Box View Background', 'striz-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
